...
ENTRYPOINT ["java", "-jar", "-Dspring.profiles.active=deploy", "-Djavax.net.ssl.trustStore=/app/truststore.jks","-Djavax.net.ssl.trustStorePassword=${TRUSTSTORE_PASSWORD}" "app.jar"]